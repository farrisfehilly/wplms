	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php _e( '38 Updates and bug fixes', 'vibe' ); ?></h4>
						<p><?php _e( 'We fixed some pending issues. Refer to change log for complete list of issues/bugs fixed in the update.', 'vibe' ); ?></p>
						<a href="http://support.vibethemes.com/solution/articles/1000188513-1-9-6" class="button"><?php _e( 'Check issue log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4><?php _e( 'Emails & Notifications Update', 'vibe' ); ?></h4>
						<p><?php _e( 'We focussed on Email and notifications feature in thsi update. A lot of new strings are added for emails and notifications, which need to translated.', 'vibe' ); ?></p>
						<a href="http://support.vibethemes.com/solution/articles/1000188513-1-9-6" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Touch Points : Emails, Messages, Notifications', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/emails.gif'; ?>" /></p>
					</div>
					<div>
						<h4><?php _e( 'Email Template', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/email_template.gif'; ?>" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Email Schedule', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/schedule_emails.png'; ?>" /></p>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Multiple Uploads in Assignments', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/assignments_multiple.png'; ?>" /></p>
					</div>
					<div>
						<h4><?php _e( 'Commission Payout graph', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/commission_payout.png'; ?>" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Instructing Modules', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/instructing_modules.png'; ?>" /></p>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'User Count Accuracy', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/count.png'; ?>" /></p>
					</div>
					<div>
						<h4><?php _e( 'Category Dropdown in Course filters', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/expandable.png'; ?>" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Search by Course Status', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course_status.png'; ?>" /></p>
					</div>
				</div>
			</div>
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4><?php _e( 'Improved Drip Feed', 'vibe' ); ?></h4>
						<p><?php _e( 'Drip Feed and Unit start date time now work on local time configured in WP admin - General settings.', 'vibe' ); ?></p>
						
					</div>
					<div >
						<h4><?php _e( 'Improved User tracking', 'vibe' ); ?></h4>
						<p><?php _e( 'Major improvements in user Activity, Notifications and emails have been added.', 'vibe' ); ?></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Improved Stats calculation', 'vibe' ); ?></h4>
						<p><?php _e( 'Improvements in stats calculation, report generation. Major improvements have been added to ensure the accuracy of stats.', 'vibe' ); ?></p>
					</div>
				</div>
			</div>
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4><?php _e( 'My Instructing Modules DashboardWidget', 'vibe' ); ?></h4>
						<p><?php _e( 'This is a new widget which shows the Modules created by instructor in the site.', 'vibe' ); ?></p>
